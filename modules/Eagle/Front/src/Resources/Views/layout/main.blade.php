                ...
                @auth()
                    ...
                    <div class="user-menu-account">
                        <div class="user-image">
                            <img src="{{ auth()->user()->banner }}" alt="بنر کاربر">
                        </div>
            ...
            <div class="sidebar-right">
                <div class="sidebar-sticky">
                    <div class="product-info-box">
                        ...
                        @guest()
                            <p>شما ابتدا باید در سایت ثبت نام کنید</p>
                        @endguest
                        @auth()
                            @if(auth()->user()->car && !auth()->user()->car->parking_id)
                                <button class="btn buy" onclick="handleBuyParking({{ $parking->id }})">رزرو پارکینگ
                                </button>
                            @elseif(!auth()->user()->car)
                                <p>شما هیچ خودرویی ثبت نکرده اید!</p>
                            @else
                                <p class="mycourse">خودرو شما در یک پارکینگ وجود دارد!</p>
                            @endif
                        @endauth
                    </div>
                    <div class="product-info-box">
                        <div class="product-meta-info-list">
                            <div class="total_sales">
                                رزرو شده ها : <span>{{ $rezervCount }}</span>
                            </div>
                            ...
                            <div class="meta-info-unit five">
                                ...
                                <span class="vlaue">@lang($parking->st())</span>
                            </div>
                        </div>
                    </div>
